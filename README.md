...
Date-rule edits are deterministic: before each edit, Codex reads the date's
current effective slots, applies only the requested add, cancel, or replace
operation, and chooses the smallest lossless rule representation. If a mixed
